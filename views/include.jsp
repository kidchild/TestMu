...
<link rel="stylesheet" href="<c:url value="/tg/commons/easyui/themes/"/>default/easyui.css" title="default" type="text/css" media="screen" />
...
<script src="<c:url value="/tg/commons/easyui/TreeGrid.js"/>"></script>
...
<script src="<c:url value="/js/jquery.formid.js"/>"></script>
